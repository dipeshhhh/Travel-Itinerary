...
export default function OnBoarding() {
  ...
  const travelingWithRadioButtons = [
    { text: "Solo", value: "solo", icon: <SoloIcon classes='radio-select-text'/> },
  ...
  return (
    <main className="onboarding-main">
      <header className="onboarding-header">
        ...
        <p className='body-text-2 onboarding-subheading'>Let's create your personalised travel experience</p>
      </header>
      <form className="onboarding-form" onSubmit={handleSubmit}>
        <section className="form-section">
          <label><h3>Where would you like to go?</h3></label>
          <TextInput
        ...
        <section className="form-section">
          <label><h3>How long will you stay?</h3></label>
          <DropDownInput
            icon={<CalendarIcon classes='onboard-input-icon-fill' />}
            dropDownIcon={<DropDownArrowIcon classes='onboard-input-icon-stroke' />}
            onChange={handleDurationInput}
          />
        </section>
        <section className="form-section">
          <label><h3>Who are you traveling with?</h3></label>
